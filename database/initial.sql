...
COPY public.accessory (id, sku, name, "deletedAt", "equipmentId") FROM stdin;
3	\N	Болт	\N	3
4	11331	Гайка	\N	4
2	\N	Гайка	\N	3
5		Пресс-муфта	\N	2
6	\N	Трубааа	2022-12-21 14:51:03.414241	3
7	string	string	\N	1
1	string	string	\N	2
10	\N	sswfwefwef	\N	1
11	\N	sswfwefwef	\N	1
...
COPY public.rental (id, "startDate", "endDate", quantity, price, "isApproved", "deletedAt", "brigadierId", "toolId") FROM stdin;
1	2023-01-19 19:16:06.575	2023-01-19	1	0.00	f	\N	1	1
2	2023-01-19 19:16:06.575	2023-01-19	1	0.00	f	\N	1	1
3	2023-01-19 19:16:06.575	2023-01-19	1	0.00	f	\N	1	1
5	2023-01-19 19:18:21.976	2023-01-19	1	0.00	f	\N	1	1
4	2023-01-19 19:16:06.575	2023-01-19	1	0.00	f	\N	2	2
\.
...
COPY public.request_report (id, file, "deletedAt", "requestId") FROM stdin;
\.
...
1	Перфоратор	\N	2	0	0	0
2	Рулетка	\N	3	0	0	0
4	Молоток	\N	3	0	0	0
5	Линейка	\N	3	0	0	0
6	t2r3443t	2022-12-21 13:25:42.606261	2	0	0	0
3	Ножницs	\N	1	0	0	0
\.
...
SELECT pg_catalog.setval('public.rental_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.request_report_id_seq', 1, false);
...
--
-- Name: rental_pkey; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX rental_pkey ON public.rental USING btree (id);
...
--
-- Name: rental FK_2c47c15ba0297857bf92f8231ad; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rental
    ADD CONSTRAINT "FK_2c47c15ba0297857bf92f8231ad" FOREIGN KEY ("toolId") REFERENCES public.tool(id);
...
--
-- Name: rental FK_403f2961507ace27b3d0e1a5b49; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rental
    ADD CONSTRAINT "FK_403f2961507ace27b3d0e1a5b49" FOREIGN KEY ("brigadierId") REFERENCES public.brigadier(id);
